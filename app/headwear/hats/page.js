    ...
    <div>
      <div className="w-full">
        <div className="relative group overflow-hidden">
          <Image
            src="/Camo-Collection-2022-2.jpg"
            width={1368}
            height={262}
            alt="Pre-curved_caps"
          ...
          <div className="absolute top-40 left-5 sm:left-40 sm:top-5 md:top-20 lg:top-24 w-full font-bold bg-opacity-50 text-white text-left px-4">
            <span className="text-5xl sm:flex-wrap sm:text-4xl md:text-5xl lg:text-7xl">
              <span className="text-yellow-400">HATS </span>.
            </span>
          </div>
        </div>
      </div>
