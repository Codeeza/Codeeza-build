    ...
    <div>
      <div className="w-full">
        <div className="relative group overflow-hidden">
          <Image
            src="/Baseball-Collection-Header.jpg"
            width={1368}
            height={262}
          ...
          />
          <div class="absolute inset-0 bg-gradient-to-r from-black to-gray-200 mix-blend-multiply opacity-50"></div>
          <div className="absolute top-20 sm:top-5 md:top-20 lg:top-24 w-full font-bold bg-opacity-50 text-white text-center px-4">
            <span className="text-5xl sm:flex-wrap sm:text-4xl md:text-5xl lg:text-7xl">
              <span className="text-orange-500">BASEBALL</span> COLLECTION
            </span>
          </div>
        </div>
      </div>
